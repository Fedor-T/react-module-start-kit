...
const APP_ENTRY_PATHS = [
  __DEV__ ? paths.client('main.js') : paths.base('index.js')
]

webpackConfig.entry = {
  main: APP_ENTRY_PATHS
}

if (__DEV__) {
  webpackConfig.entry.vendor = config.compiler_vendor
}
...
if (!__DEV__) {
  webpackConfig.output.libraryTarget = 'umd' // commonjs2  - for webpack
  webpackConfig.output.library = 'LIB-NAME'
}
